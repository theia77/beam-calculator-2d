...
export default function App() {
  ...
  const [distLoad, setDistLoad] = useState({ active: false, startMag: 10, endMag: 20, startPos: 2, endPos: 8, dir: 'down' });
  ...
  const { plotData, reactions, peakMoment } = useMemo(() => {
    ...
    if (distLoad.active) {
      ...
      activeLoads.push({
        type: 'distributed',
        startPos: distLoad.startPos,
        endPos: distLoad.endPos,
        startMag: distLoad.startMag * multiplier,
        endMag: distLoad.endMag * multiplier,
      });
    }
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <div style={{ background: '#f8fafc', padding: '20px', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
            ...
            <BeamSetupView
              ...
              pointLoad={pointLoad} momentLoad={momentLoad} distLoad={distLoad}
            />
          </div>
